package faroukh.davouzov.cryptouitgelegd.filter;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.fasterxml.jackson.databind.ObjectMapper;
import faroukh.davouzov.cryptouitgelegd.service.UserService;
import faroukh.davouzov.cryptouitgelegd.service.UserServiceImpl;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
        ...
        faroukh.davouzov.cryptouitgelegd.domain.User customUser = userService.getUser(user.getUsername());
        ...
        tokens.put("name", customUser.getName());
